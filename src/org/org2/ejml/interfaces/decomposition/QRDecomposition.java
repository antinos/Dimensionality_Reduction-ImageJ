 ...
 * <li> Can incrementally add and remove columns from the decomposed matrix.  See {@link org.org2.ejml.dense.row.linsol.qr.AdjLinearSolverQr_DDRM} </li>
 * </ul>
 *
...
public interface QRDecomposition <T extends Matrix>
     ...
     * called after {@link #decompose(org.org2.ejml.data.Matrix)} has been.
     * </p>
     * <p>
