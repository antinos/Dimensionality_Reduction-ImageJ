...
package org.org2.ejml.dense.block;
...
public class VectorOps_FDRB {
    ...
    public static void add_row(final int blockLength ,
        ...
        final float dataA[] = A.original.data;
        final float dataB[] = B.original.data;
        final float dataC[] = C.original.data;
     ...
     */
    public static float dot_row(final int blockLength,
                                 FSubmatrixD1 A, int rowA,
                                 FSubmatrixD1 B, int rowB,
                                 int offset, int end) {
     ...
     * @return Results of the dot product.
     */
    public static float dot_row_col(final int blockLength,
                                     FSubmatrixD1 A, int rowA,
                                     FSubmatrixD1 B, int colB,
                                     int offset, int end) {
