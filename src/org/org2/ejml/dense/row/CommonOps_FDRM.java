...
package org.org2.ejml.dense.row;

import org.jetbrains.annotations.Nullable;
import org.org2.ejml.EjmlParameters;
import org.org2.ejml.LinearSolverSafe;
import org.org2.ejml.MatrixDimensionException;
import org.org2.ejml.UtilEjml;
import org.org2.ejml.data.*;
import org.org2.ejml.dense.row.decomposition.TriangularSolver_FDRM;
import org.org2.ejml.dense.row.decomposition.lu.LUDecompositionAlt_FDRM;
import org.org2.ejml.dense.row.factory.LinearSolverFactory_FDRM;
import org.org2.ejml.dense.row.linsol.chol.LinearSolverChol_FDRM;
import org.org2.ejml.dense.row.linsol.lu.LinearSolverLu_FDRM;
import org.org2.ejml.dense.row.linsol.svd.SolvePseudoInverseSvd_FDRM;
import org.org2.ejml.dense.row.misc.*;
import org.org2.ejml.dense.row.mult.MatrixMatrixMult_FDRM;
import org.org2.ejml.dense.row.mult.MatrixMultProduct_FDRM;
import org.org2.ejml.dense.row.mult.MatrixVectorMult_FDRM;
import org.org2.ejml.dense.row.mult.VectorVectorMult_FDRM;
import org.org2.ejml.interfaces.linsol.LinearSolverDense;
import org.org2.ejml.interfaces.linsol.ReducedRowEchelonForm_F32;

import static org.org2.ejml.UtilEjml.stringShapes;
...
public class CommonOps_FDRM {
     ...
     * needed, then using {@link org.org2.ejml.interfaces.decomposition.LUDecomposition_F32} directly (or any
