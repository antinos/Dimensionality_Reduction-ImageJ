...
package org.org2.ejml.dense.row.misc;
 ...
 * </p>
 *
 * @see org.org2.ejml.dense.row.decomposition.lu.LUDecompositionAlt_FDRM
 *
 * @author Peter Abeles
 */
public class DeterminantFromMinor_FDRM {
    ...
    public DeterminantFromMinor_FDRM(int width , int minWidth )
    {
        ...
        levelResults = new float[numLevels];
        levelRemoved = new int[numLevels];
        levelIndexes = new int[numLevels];

        open = new int[ width ];

        tempMat = new FMatrixRMaj(minWidth-1,minWidth-1);
    }
