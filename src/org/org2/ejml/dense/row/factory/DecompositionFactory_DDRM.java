...
import org.org2.ejml.data.DMatrix;
import org.org2.ejml.data.DMatrixRMaj;
import org.org2.ejml.dense.row.CommonOps_DDRM;
import org.org2.ejml.dense.row.EigenOps_DDRM;
import org.org2.ejml.dense.row.NormOps_DDRM;
import org.org2.ejml.dense.row.SpecializedOps_DDRM;
import org.org2.ejml.dense.row.decomposition.chol.CholeskyDecompositionBlock_DDRM;
import org.org2.ejml.dense.row.decomposition.chol.CholeskyDecompositionInner_DDRM;
import org.org2.ejml.dense.row.decomposition.chol.CholeskyDecompositionLDL_DDRM;
import org.org2.ejml.dense.row.decomposition.chol.CholeskyDecomposition_DDRB_to_DDRM;
import org.org2.ejml.dense.row.decomposition.eig.SwitchingEigenDecomposition_DDRM;
import org.org2.ejml.dense.row.decomposition.eig.SymmetricQRAlgorithmDecomposition_DDRM;
import org.org2.ejml.dense.row.decomposition.eig.WatchedDoubleStepQRDecomposition_DDRM;
import org.org2.ejml.dense.row.decomposition.hessenberg.TridiagonalDecompositionHouseholder_DDRM;
import org.org2.ejml.dense.row.decomposition.hessenberg.TridiagonalDecomposition_DDRB_to_DDRM;
...
import org.org2.ejml.dense.row.decomposition.qr.QRDecompositionHouseholderColumn_DDRM;
import org.org2.ejml.dense.row.decomposition.svd.SvdImplicitQrDecompose_DDRM;
...
public class DecompositionFactory_DDRM {
    ...
    /**
     * <p>
     * Returns a {@link org.org2.ejml.dense.row.decomposition.chol.CholeskyDecompositionLDL_DDRM} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param matrixSize Number of rows and columns that the returned decomposition is optimized for.
