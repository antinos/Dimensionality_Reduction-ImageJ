...
import org.org2.ejml.data.FMatrix;
import org.org2.ejml.data.FMatrixRMaj;
import org.org2.ejml.dense.row.CommonOps_FDRM;
import org.org2.ejml.dense.row.EigenOps_FDRM;
import org.org2.ejml.dense.row.NormOps_FDRM;
import org.org2.ejml.dense.row.SpecializedOps_FDRM;
import org.org2.ejml.dense.row.decomposition.chol.CholeskyDecompositionBlock_FDRM;
import org.org2.ejml.dense.row.decomposition.chol.CholeskyDecompositionInner_FDRM;
import org.org2.ejml.dense.row.decomposition.chol.CholeskyDecompositionLDL_FDRM;
import org.org2.ejml.dense.row.decomposition.chol.CholeskyDecomposition_FDRB_to_FDRM;
import org.org2.ejml.dense.row.decomposition.eig.SwitchingEigenDecomposition_FDRM;
import org.org2.ejml.dense.row.decomposition.eig.SymmetricQRAlgorithmDecomposition_FDRM;
import org.org2.ejml.dense.row.decomposition.eig.WatchedDoubleStepQRDecomposition_FDRM;
import org.org2.ejml.dense.row.decomposition.hessenberg.TridiagonalDecompositionHouseholder_FDRM;
import org.org2.ejml.dense.row.decomposition.hessenberg.TridiagonalDecomposition_FDRB_to_FDRM;
import org.org2.ejml.dense.row.decomposition.lu.LUDecompositionAlt_FDRM;
import org.org2.ejml.dense.row.decomposition.qr.QRColPivDecompositionHouseholderColumn_FDRM;
import org.org2.ejml.dense.row.decomposition.qr.QRDecompositionHouseholderColumn_FDRM;
import org.org2.ejml.dense.row.decomposition.svd.SvdImplicitQrDecompose_FDRM;
import org.org2.ejml.interfaces.decomposition.*;
...
public class DecompositionFactory_FDRM {
    ...
    /**
     * <p>
     * Returns a {@link org.org2.ejml.dense.row.decomposition.chol.CholeskyDecompositionLDL_FDRM} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param matrixSize Number of rows and columns that the returned decomposition is optimized for.
    ...
    /**
     * <p>
     * Returns a {@link org.org2.ejml.interfaces.decomposition.LUDecomposition} that has been optimized for the specified matrix size.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns a {@link org.org2.ejml.interfaces.decomposition.QRDecomposition} that has been optimized for the specified matrix size.
     * </p>
     *
     * @param numRows Number of rows the returned decomposition is optimized for.
     * @param numCols Number of columns that the returned decomposition is optimized for.
