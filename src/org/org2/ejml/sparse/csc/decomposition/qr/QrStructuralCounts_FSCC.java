...
import org.org2.ejml.sparse.csc.misc.ColumnCounts_FSCC;
...
public class QrStructuralCounts_FSCC {
    ...
    FMatrixSparseCSC A; // reference to input matrix
    ...
    public boolean process( FMatrixSparseCSC A ) {
        ...
        TriangularSolver_FSCC.eliminationTree(A,true,parent,gwork);
    ...
    void countNonZeroInR( int[] parent ) {
        TriangularSolver_FSCC.postorder(parent,n,post,gwork);
